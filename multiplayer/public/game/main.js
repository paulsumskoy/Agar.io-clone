...
function setup() {
  ...
  for (var i = 0; i < 50; i++) {
    //мы также создаем частицы за пределами окна, поскольку они перемещаются в соответствии с нашей позицией с помощью
...
function draw() {
  ...
  //масштабируем, чтобы уменьшить масштаб по мере роста нашей капли
  scale(zoom);
